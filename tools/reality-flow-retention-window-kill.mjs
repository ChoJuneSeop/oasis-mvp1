...
try{
  ...
  const interpretation=!Object.values(controls).every(Boolean)
    ...
    :materialDifference
      ?'STAGE13_FIXED_RECENCY_WINDOW_MATERIALLY_AFFECTS_REALITY_FLOW'
      :'STAGE13_FIXED_RECENCY_WINDOW_NOT_MATERIAL_IN_TESTED_FLOW';
  const report={
