...
for(const f of ['prehistoric-society-v3-core.js','prehistoric-society-v3-decisions.js','prehistoric-society-v3-world.js','prehistoric-singularity-v4.js','prehistoric-cooperation-v4.js','prehistoric-late-paleolithic-v5.js','prehistoric-exposure-v6.js','prehistoric-ritual-observer-v6.js','prehistoric-primitive-bridge-v7.js'])vm.runInThisContext(fs.readFileSync(path.join(here,f),'utf8'),{filename:f});
...
function snapshot(){
 ...
 const markObservers=non.filter(a=>a.culture.knownKinds?.has('persistent_mark')||a.culture.actions?.['observe:mark']).length;
 ...
 const coopHunts=(E.coopHunts||0)+(E.primitiveWorld?.coopHunts||0),coopHuntSuccess=(E.coopHuntSuccess||0)+(E.primitiveWorld?.coopSuccess||0);
 return{tick:E.tick,population:pop.length,births:E.births,deaths:E.deaths,maxGeneration:E.maxGeneration,hearths,relationPairs:relPairs.size,cultureRich,advanced,markObservers,coopHunters,coopHunts,coopHuntSuccess,innovations:E.innovations,milestones:E.milestones,lateMilestones:E.lateMilestones,lateWorld:E.lateWorld,exposure:E.exposure,ritualObserver:E.ritualObserver,primitiveWorld:E.primitiveWorld};
}
...
globalThis.__RESULT__={reached:!!reached,finalState,founders,simMilestones,simSequence,recentLog:E.log.slice(0,45),checkpoints:checkpoints.slice(-12)};
`);
